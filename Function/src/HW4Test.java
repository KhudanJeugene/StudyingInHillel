...
public class HW4Test
{
	...
	{
		int n = 50;
		String res ="Четыреста";
		assertEquals(res,HW4.numberToWords(n));
	}
	public void testNumberToWords_452()
	{
		int n = 452;
		String res ="Четыреста Пятьдесят Два";
		assertEquals(res,HW4.numberToWords(n));
	}
	...
	{
		int n = 800;
		String res ="Восемьсот";
		assertEquals(res,HW4.numberToWords(n));
	}
	public void testNumberToWords_900()
	{
		int n = 900;
		String res ="Девятьсот";
		assertEquals(res,HW4.numberToWords(n));
	}
